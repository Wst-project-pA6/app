...
describe('TrainingGroupsController', () => {
  ...
  it('delegates every operation and exposes exact permissions', async () => {
    ...
    const controller = new TrainingGroupsController(service as never);
    const query = { page: 1, pageSize: 20 };
    const dto = { name: 'Cohort A', courseId: '22222222-2222-4222-8222-222222222222' } as never;
    ...
    const handler = (name: string): Function => Reflect.get(TrainingGroupsController.prototype, name) as Function;
  ...
  it('validates group UUID path parameters', async () => {
